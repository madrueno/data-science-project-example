...
This experiment fine-tunes a pre-trained DistilBERT model for spam classification.
...
def main(args):
    """Load dataset, fine-tune BERT, and evaluate on train and dev."""
    # ===== DATASET / PIPELINE =====
    ...
    train_results = evaluate_metrics(dataset.y_train, train_predictions)
    ...
    dev_results = evaluate_metrics(dataset.y_dev, dev_predictions)
    ...
    print_experiment_summary(train_results, dev_results, experiment_name=experiment)
